...
export default function FourZeroFour() {
  return (
    <>
      <PageSEO title="404" description="抱歉，当前页面无法正常访问 :(" />
      <div className="mt-[160px] flex flex-col items-start justify-start md:mt-24 md:flex-row md:items-center md:justify-center md:space-x-6">
