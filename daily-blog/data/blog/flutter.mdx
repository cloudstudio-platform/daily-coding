---
title: 'Cloud Studio + CODING 在线完成 Flutter 项目开发全过程-腾讯云'
subTitle: '通过 Cloud Studio + CODING 在线完成 Flutter 项目开发实战'
summary: '本文描述如何通过 Cloud Studio 实现 Flutter 项目的云端编程；再利用 CODING 的代码仓库托管代码、CI 流水线实现自动打包 APK 文件并存储在制品库。'
tags: ['远程开发', '使用指南']
date: '2023-04-03'
author: '林梓泓'
avatar: 'https://help-assets.codehub.cn/enterprise/20230331113942.png'
