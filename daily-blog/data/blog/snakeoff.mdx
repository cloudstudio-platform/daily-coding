---
title: 'Cloud Studio 开发运行 GUI 程序之贪吃蛇'
subTitle: Cloud Studio 开发运行示例
date: 2023-05-22
tags: ['云端开发', '开发示例']
draft: false
...
[屏幕录制2023-03-21 上午10.29.52.mov](https://drive.weixin.qq.com/s?k=AJEAIQdfAAooIBLxjjAZQApAYNADA)
