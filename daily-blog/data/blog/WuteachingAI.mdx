---
title: 教你快速上手AI应用——吴恩达AI系列教程 第一课
subTitle: 吴恩达教你快速上手AI应用
date: '2023-9-11'
tags: ['吴恩达AI系列教程']
summary: 如何通过AI创造一个回答问题的披萨店客服
description: 介绍吴恩达AI系列教程的第一部分,教你如何快速上手AI应用——我们将学习如何利用AI通过prompt工程创造一个披萨店的客服人员,通过和它的对话我们可以购买需要的披萨。
